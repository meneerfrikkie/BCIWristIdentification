...
saveFolder = sprintf('../OwnResults/FigureEEGData/%s',PatientID); % Change this to your desired folder path
...
% Define the folder where the plots will be saved
saveFolderWE = sprintf('../OwnResults/FigureEEGData/%s/WE',PatientID); % Change this to your desired folder path
...
% Define the folder where the plots will be saved
saveFolderWF = sprintf('../OwnResults/FigureEEGData/%s/WF',PatientID); % Change this to your desired folder path
